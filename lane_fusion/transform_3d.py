...
class CustomCollect3D(object):
    ...
    def __call__(self, results):
        """Collect data and pack into DetDataSample (MMDet 3.x style)."""

        data = {}
        data_sample = DetDataSample()

        # ---- collect meta info (CPU-only by default) ----
        metainfo = {}
